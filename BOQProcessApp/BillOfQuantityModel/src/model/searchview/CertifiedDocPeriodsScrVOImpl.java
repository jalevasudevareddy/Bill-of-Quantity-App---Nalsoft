...
// ---------------------------------------------------------------------
public class CertifiedDocPeriodsScrVOImpl extends ViewObjectImpl {
    /**
     * This is the default constructor (do not remove).
     */
    public CertifiedDocPeriodsScrVOImpl() {
    }
    ...
    /**
     * Returns the bind variable value for p_ref_id.
     * @return bind variable value for p_ref_id
     */
    public BigDecimal getp_ref_id() {
        return (BigDecimal)getNamedWhereClauseParam("p_ref_id");
    }

    /**
     * Sets <code>value</code> for bind variable p_ref_id.
     * @param value value to bind as p_ref_id
     */
    public void setp_ref_id(BigDecimal value) {
        setNamedWhereClauseParam("p_ref_id", value);
    }
