...
// ---    Mon Jan 23 17:45:02 IST 2017
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class XxboqProgressDetailsHdrEOImpl extends EntityImpl {
    ...
    public enum AttributesEnum {
        DocHeaderId {
            public Object get(XxboqProgressDetailsHdrEOImpl obj) {
                return obj.getDocHeaderId();
            }

            public void put(XxboqProgressDetailsHdrEOImpl obj, Object value) {
        ...
        XxboqProgressDetailsLinesEO {
            public Object get(XxboqProgressDetailsHdrEOImpl obj) {
                return obj.getXxboqProgressDetailsLinesEO();
            }
        ...
        public abstract Object get(XxboqProgressDetailsHdrEOImpl object);

        public abstract void put(XxboqProgressDetailsHdrEOImpl object,
                                 Object value);
    ...
    public static final int XXBOQPROGRESSDETAILSLINESEO =
        AttributesEnum.XxboqProgressDetailsLinesEO.index();

    /**
     * This is the default constructor (do not remove).
     */
    public XxboqProgressDetailsHdrEOImpl() {
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject =
                    EntityDefImpl.findDefObject("model.entity.XxboqProgressDetailsHdrEO");
        }
    ...
    /**
     * Gets the attribute value for AsOnDate, using the alias name AsOnDate.
     * @return the AsOnDate
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for AsOnDate.
     ...
     */
    public RowIterator getXxboqProgressDetailsLinesEO() {
        return (RowIterator)getAttributeInternal(XXBOQPROGRESSDETAILSLINESEO);
    }
    ...
    protected void create(AttributeList attributeList) {
        ...
        SequenceImpl seq =
            new SequenceImpl("XXBOQ_PROGRESS_DETAILS_HDR_S", getDBTransaction());
